...
CREATE TABLE `comment_subject` (
  ...
  `dislike` bigint(20) DEFAULT 0 COMMENT '踩/2023-04-13',
  `reply_cnt` bigint(20) DEFAULT 0 COMMENT '评论数/2023-04-13',
  `state` bigint(20) unsigned NOT NULL COMMENT '状态/0启用/1删除',
  `seq` bigint(20) unsigned DEFAULT 0 COMMENT '序列号, 每次更新行时+1',
...
CREATE TABLE `comment_item` (
  ...
  `floor` bigint(20) DEFAULT 0 COMMENT '楼层/2023-04-13',
  `user_id` bigint(20) DEFAULT 0 COMMENT '用户ID/2023-04-13',
  `replyto` bigint(20) DEFAULT 0 COMMENT '回复用户ID/2023-04-13',
  `like` bigint(20) DEFAULT 0 COMMENT '赞/2023-04-13',
  `dislike` bigint(20) DEFAULT 0 COMMENT '踩/2023-04-13',
  `reply_cnt` bigint(20) DEFAULT 0 COMMENT '回复数/2023-04-13',
  `state` bigint(20) unsigned NOT NULL COMMENT '状态/0启用/1删除',
  `seq` bigint(20) unsigned DEFAULT 0 COMMENT '序列号, 每次更新行时+1',
...
CREATE TABLE `comment_content` (
  ...
  `content` varchar(512) DEFAULT empty COMMENT '评论内容/2023-04-13',
